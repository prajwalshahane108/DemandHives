...
const GradientText = styled(Typography)(({ theme }) => ({
  background:
    "linear-gradient(90deg, #8E63E6 0%, #4BDBC3 33%, #F8BA85 66%, #E57BBE 100%)",
...
const Banner = () => {
  ...
  // Updated promotional texts for Global Supply Connect
  const promoTexts = [
    { prefix: "Global", highlight: "Supply Connect", suffix: "Bridging Demand & Supply" },
    { prefix: "Your Trusted", highlight: "Procurement Partner", suffix: "Worldwide" },
    { prefix: "Seamless", highlight: "Bulk Sourcing", suffix: "Made Easy" },
    { prefix: "From Hotels to", highlight: "Retailers", suffix: "We Deliver!" },
    { prefix: "Get Hassle-Free", highlight: "Global Logistics", suffix: "With Us!" },
  ];
      ...
      <Container maxWidth="xl" sx={{ padding: 0 }}>
        <MarqueeContainer>
          <MarqueeContent animate={animate} speed={70} ref={contentRef}>
            ...
            {[...promoTexts, ...promoTexts, ...promoTexts, ...promoTexts].map(
              (text, index) => (
